...
/*******************************************************************************
 * Typedefs for USB Device Request Setup Data
 ******************************************************************************/
...
typedef enum UsbRecipient_e {
    e_RecipientDevice       = 0x00,
    e_RecipientInterface    = 0x01,
    e_RecipientEndpoint     = 0x02,
    e_RecipientOther        = 0x03
} UsbRecipient_t;

typedef enum UsbDeviceRequest_e {
    e_GetStatus         = 0x00,
    e_ClearFeature      = 0x01,
    e_SetFeature        = 0x03,
    e_SetAddress        = 0x05,
...
/*******************************************************************************
 * Typedefs for USB Get Status Request
 ******************************************************************************/
